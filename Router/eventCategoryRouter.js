...
const eventCategoryRouter = require('../controller/eventCategoryController')
...
router.post("/addCategory",eventCategoryRouter.addCategory)
router.get("/getCategory",eventCategoryRouter.getCategory)
/**
* @swagger
* /user/otpVerify:
*   put:
